...
<div className='bg-[#032d42] '>
            <div className="lg:flex lg:flex-row max-w-[1400px] xl:mt-[75px] mx-auto  md:flex md:flex-col sm:flex sm:flex-col justify-start items-start">
...
<div className='max-w-[1400px] mx-auto '>
            <div className='sm:flex font-face-mm w-[100%]  sm:flex-row  flex flex-col justify-center text-left sm:justify-between  mt-32 text-[#999] md:text-lg sm:text-[16px]  font-semibold xl:w-[55%] lg:w-[70%] sm:w-[90%]  mx-5 sm:mx-auto xl:mx-auto'>
            ...
            <div className='max-w-[1400px] mx-auto' >
                <div className='w-[60%] m-auto mt-32 xl:text-3xl text-xl  font-bold font-face-gm '> <p>{props.trust}</p></div>
            </div>
