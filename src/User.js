...
function User(props) {
    ...
    return (
        <div className=''>
            <div className='w-[100%] lg:hidden flex justify-start px-6'>
...
<div className='bg-[#032d42] '>
            <div className="lg:flex lg:flex-row max-w-[1400px] xl:mt-[87px] mx-auto  md:flex md:flex-col sm:flex sm:flex-col justify-start items-start">
                <div className="lg:w-[50%] md:w-[100%] pb-5 sm:pb-0 sm:w-[100%] bg-[#032d42] xl:h-[500px] lg:h-[500px] md:h-[500px] sm:h-[400px] ">
                    ...
                    <p className='text-[#fff] leading-7 font-face-rm sm:leading-10 xl:text-[1.6rem] md:text-[1.6rem] lg:text-[1.2rem] w-[96%] sm:text-[1.2rem] text-left px-5  sm:px-10 ' >Save or grow? Satisfy shareholders or satisfy customers? When facing tough choices, choose the one platform that lets you say <span className='text-[#62d84e] font-bold'>YES</span> to both.</p>
                    <button className='flex items-start font-face-mm  ml-5 sm:ml-10 sm:mx-10  bg-[#62d84e] sm:mt-14 mt-4 py-3 sm:py-4 xl:px-11 md:px-11 px-5 sm:px-11 lg:px-8 rounded-md sm:text-xl text-sm '>
                        {props.make}
                    </button>


                </div>
                <div className="lg:w-[50%] md:w-[100%]    sm:w-[100%] xl:h-[500px] lg:h-[500px] sm:h-[400px]  ">
...
<div className='max-w-[1400px] mx-auto '>
            <div className='md:flex md:flex-row  flex flex-col lg:justify-around sm:justify-between md:justify-between mx-5 lg:px-20 sm:px-5 md:px-10 py-10 border-b-2 border-gray-300 '>
                ...
                <div className='flex md:mt-0 mt-6 cursor-pointer'> <img className='md:w-12 md:h-12 w-10 h-10  ' src={bell} /> <h1 className='font-face-gm sm:text-[18px] pl-5 md:mt-2  sm:mt-1 lg:ml-5 sm:pt-0 sm:ml-2 ml-2'>{props.forcontact}
            ...
            <div className="lg:flex lg:flex-row max-w-[1400px] mx-auto  lg:justify-start md:flex md:flex-col px-10 mt-20 items-start">
                <div className="lg:w-[50%]  md:w-[100%]  ">
                    <img src={clienta} />
                </div>
                <dv className="lg:w-[50%]   md:w-[100%]     ">
                    <h1 className='xl:text-4xl font-face-gm md:text-4xl sm:text-3xl lg:text-3xl font-bold  flex items-start md:px-0  lg:px-10 xl:pt-5 lg:pt-1 pt-5 xl:pb-5 lg:pb-3'>
                        {props.h2}</h1>
                    <p style={{lineHeight:"36px"}} className=' md:text-xl text-[#2C4641]  font-face-rm sm:text-[18px] xl:w-[90%] lg:w-[100%] flex justify-start text-left lg:px-10 md:px-0 leading-[70px]   lg:pt-0 pt-5 ' >{props.para2}</p>
                    <button className='flex items-start font-face-mm lg:text-[20px]  md:mx-0 lg:mx-10  border-[2px] border-[#62d84e] lg:mt-5  mt-10  xl:mt-10 sm:py-4 sm:px-10 px-5 py-3 lg:px-7 xl:px-10 rounded-md relative   bg-transparent text-black-800 transition-colors before:absolute before:left-0 before:top-0 before:-z-10 before:h-full before:w-full before:origin-top-left before:scale-x-0 before:bg-[#62d84e] before:transition-transform before:duration-300  hover:text-black before:hover:scale-x-100   '>
                        {props.explore}
                    </button>
...
<div className='max-w-[1400px] mx-auto '>
            <div className='sm:flex font-face-mm w-[100%]  sm:flex-row  flex flex-col justify-center text-left sm:justify-between  mt-32 text-[#999] md:text-xl sm:text-[16px]  font-semibold xl:w-[55%] lg:w-[70%] sm:w-[90%]  mx-5 sm:mx-auto xl:mx-auto'>
            ...
            {
                selectedDiv === 1 && <div className="lg:flex max-w-[1400px] mx-auto  lg:flex-row sm:flex sm:flex-col-reverse justify-start px-10 mt-20 items-start">

                    <div className="lg:w-[50%] sm:w-[100%] mt-40   ">
                        <h2 className='flex items-start text-lg font-face-gm  font-bold'>{props.it}</h2>
            ...
            {selectedDiv === 2 && <div className="lg:flex max-w-[1400px] mx-auto  lg:flex-row sm:flex sm:flex-col-reverse justify-start px-10 mt-20 items-start">

                <div className="lg:w-[50%] sm:w-[100%]  mt-40   ">
                    <h2 className='flex items-start text-lg font-face-gm  font-bold'>{props.Employee}</h2>
            ...
            {selectedDiv === 3 && <div className="lg:flex lg:flex-row sm:flex sm:flex-col-reverse justify-start px-10 mt-20 max-w-[1400px] mx-auto  items-start">

                <div className="lg:w-[50%] sm:w-[100%]  mt-40   ">
                    <h2 className='flex items-start font-face-gm text-lg  font-bold'>{props.Customer}</h2>
                    <h1 className='sm:text-4xl text-xl font-bold font-face-gm  flex items-start  pt-5 pb-5'>
                        {props.part3h3}</h1>
            ...
            {selectedDiv === 4 && <div className="lg:flex max-w-[1400px] mx-auto  lg:flex-row sm:flex sm:flex-col-reverse justify-start px-10 mt-20 items-start">

                <div className="lg:w-[50%] sm:w-[100%]  mt-40   ">
                    <h2 className='flex items-start font-face-gm text-lg  font-bold'>{props.Creator} </h2>
                    <h1 className='sm:text-4xl text-xl font-bold font-face-gm  flex items-start  pt-5 pb-5'>
                        {props.part4h3}</h1>
                    ...
                    <button className='flex items-start  font-semibold border-[2px] border-[#62d84e] mt-10 py-4 px-10 rounded-md  relative   bg-transparent text-black-800 transition-colors before:absolute before:left-0 before:top-0 before:-z-10 lg:text-[20px] font-face-mm before:h-full before:w-full before:origin-top-left before:scale-x-0 before:bg-[#62d84e] before:transition-transform before:duration-300  hover:text-black before:hover:scale-x-100 '>
                        {props.btn3}
                    </button>
            ...
            <div className="lg:flex max-w-[1400px] mx-auto lg:flex-row md:flex md:flex-col justify-start px-10 mt-32 items-start">
                <div className="lg:w-[50%]  w-[100%]  ">
                    <img src={clientc} />
                </div>
                <div className="lg:w-[50%]  w-[100%]    ">
                    <h1 className='xl:text-3xl font-face-gm sm:text-3xl lg:text-2xl font-bold  flex items-start md:px-0 pt-5  lg:px-10 xl:pt-5 lg:pt-1 xl:pb-5 lg:pb-3'>
                        {props.h4}</h1>
                    <p style={{lineHeight:"36px"}} className='text-[#2C4641] md:text-xl text-lg font-face-rm leading-8  sm:text-[18px] xl:w-[90%] lg:w-[95%] md:mx-0 lg:mx-10 flex justify-start text-left  pt-5 lg:pt-0
                     '  >{props.para4}</p>
                    <button className='flex items-start lg:mx-10 font-semibold border-[2px] border-[#62d84e] lg:mt-5 xl:mt-10 mt-5 sm:mt-10 py-4 px-10   lg:px-7 xl:px-10 rounded-md  relative font-face-mm lg:text-[20px]  bg-transparent text-black-800 transition-colors before:absolute before:left-0 before:top-0 before:-z-10 before:h-full before:w-full before:origin-top-left before:scale-x-0 before:bg-[#62d84e] before:transition-transform before:duration-300  hover:text-black before:hover:scale-x-100 '>
                        {props.explore}
                    </button>
            ...
            <div className='max-w-[1400px] mx-auto' >
                <div className='w-[60%] m-auto mt-20 xl:text-3xl text-xl  font-bold font-face-gm '> <p>{props.trust}</p></div>
            </div>
...
<div className='bg-[#032d42]'>
            <div className='lg:flex max-w-[1400px] mx-auto lg:flex-row  md:flex md:flex-col-reverse mt-10 '>
                ...
                <div className='lg:w-[50%] md:w-[100%] w-[100%] md:py-16 pt-10 sm:pb-2 lg:py-32 text-left px-10'>
                    ...
                    <p style={{lineHeight:"36px"}} className='xl:text-[21px]  text-lg sm:text-xl font-face-rm w-[89%] mt-5 text-[#fff]'>{props.bluepara}</p>
                    <button className='text-[#fff] z-10 text-lg font-semibold border-[2px] border-[#62d84e] mt-10 py-4 font-face-mm px-10 rounded-md relative   bg-transform text-black-800 transition-colors before:absolute before:left-0 before:top-0 before:-z-10 before:h-full before:w-full before:origin-top-left before:scale-x-0 before:bg-[#62d84e] before:transition-transform before:duration-300  hover:text-black before:hover:scale-x-100  '>{props.btnforblue}</button><span className='pl-8 text-[#fff] font-semibold text-lg'>{props.Stories}</span>
                ...
                <div className='bg-[#f7f7f7]  flex flex-col flex-wrap' >
                    <div className='md:flex md:flex-row flex flex-col justify-between w-[100%] px-10  text-left '>
                        ...
                        <div className='lg:w-[31%] md:w-[32%] overflow-hidden md:mt-0 mt-10 w-[100%] bg-[#fff]'> <div className='md:h-[200px] sm:h-500px '><img className='lg:w-[100%] md:w-[100%] m-auto transform transition duration-500 hover:scale-110 sm-[350px] md:h-full' src={box2} /></div>
                            <div className='mx-4 mt-4 '>
                                <h1 className='font-bold font-face-gm  '>{props.box2h1}</h1>
                        ...
                        <div className='lg:w-[31%] md:w-[32%] overflow-hidden md:mt-0 mt-10 w-[100%] bg-[#fff]'> <div className='md:h-[200px] sm:h-500px ' ><img className='lg:w-[100%] md:w-[100%] m-auto transform transition duration-500 hover:scale-110 sm-[350px] md:h-full' src={box3} /></div>
                            <div className='mx-4 mt-4 '>
                                <h1 className='font-bold  font-face-gm'>{props.box3h1}</h1>
                ...
                <div className='bg-[#f7f7f7] ' >
                    <div className='md:flex md:flex-row flex  flex-col justify-between w-[100%] px-10 pt-10  text-left '>
                        <div className='lg:w-[31%] md:w-[32%] overflow-hidden w-[100%]  bg-[#fff]'> <div className='md:h-[200px] sm:h-500px ' ><img className='lg:w-[100%] md:w-[100%] m-auto  sm-[350px] transform transition duration-500 hover:scale-110 md:h-full' src={box4} /></div>
                            <div className='mx-4 mt-4 '>
                                <h1 className='font-bold font-face-gm  '>{props.box4h1}</h1>
                        ...
                        <div className='lg:w-[31%] md:w-[32%] overflow-hidden w-[100%] md:mt-0 mt-10  bg-[#fff]'> <div className='md:h-[200px] sm:h-500px ' ><img className='lg:w-[100%] md:w-[100%] m-auto transform transition duration-500 hover:scale-110 sm-[350px] md:h-full' src={box5} /></div>
                            <div className='mx-4 mt-4 '>
                                <h1 className='font-bold font-face-gm  '>{props.box5h1}</h1>
                        ...
                        <div className='lg:w-[31%] md:w-[32%] overflow-hidden w-[100%]  md:mt-0 mt-10  bg-[#fff]'> <div className='md:h-[200px] sm:h-500px ' ><img className='lg:w-[100%] md:w-[100%] m-auto transform transition duration-500 hover:scale-110 sm-[350px] md:h-full' src={box6} /></div>
                            <div className='mx-4 mt-4'>
                                <h1 className='font-bold  font-face-gm '>{props.box6h1}</h1>
